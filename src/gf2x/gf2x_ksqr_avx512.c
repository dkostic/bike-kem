...
#  define map_word         uint16_t
#  define __mmask          __mmask32
...
#  define map_word         uint32_t
#  define __mmask          __mmask16
...
_INLINE_ void generate_map(OUT map_word *map, IN const map_word l_param)
{
...
{
  ALIGN(ALIGN_BYTES) map_word map[R_PADDED];
